...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s.setUserAgentString("Mozilla/5.0 (Linux; Android 11) AppleWebKit/537.36 Chrome/120.0.0.0 Safari/537.36");
        webView.setWebViewClient(new WebViewClient() {
            @Override
            public void onReceivedSslError(WebView v, SslErrorHandler h, SslError e) { h.proceed(); }
            @Override
            public void onPageFinished(WebView v, String url) {
                v.evaluateJavascript("javascript:(function(){document.body.style.background='#000';document.body.style.margin='0';})()", null);
            }
        });
